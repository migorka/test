...
static esp_capture_video_src_if_t *create_video_source(void)
{
    ...
    if (cam_pin_cfg.type == CAMERA_TYPE_DVP) {
        ...
        dvp_config.reset_pin = -1;
        dvp_config.pwr_pin = -1;
        dvp_config.data[0] = 39;
        dvp_config.data[1] = 40;
        dvp_config.data[2] = 41;
        dvp_config.data[3] = 42;
        dvp_config.data[4] = 15;
        dvp_config.data[5] = 16;
        dvp_config.data[6] = 48;
        dvp_config.data[7] = 47;
        dvp_config.vsync_pin = 46;
        dvp_config.href_pin = 38;
        dvp_config.pclk_pin = 45;
        dvp_config.xclk_pin = -1;
        dvp_config.xclk_freq = 20000000;
