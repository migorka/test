...
#else
#define TEST_BOARD_NAME "CAMERA_MODEL_M5STACK_CORES3"
#endif
...
#define VIDEO_FPS    25
#else
#define VIDEO_WIDTH  648
#define VIDEO_HEIGHT 488
#define VIDEO_FPS    10
#endif
 ...
 */
#define WIFI_SSID     "dom_xx_2"

/**
 * @brief  Set for wifi password
 */
#define WIFI_PASSWORD "a1px78esa45kxFGP"
